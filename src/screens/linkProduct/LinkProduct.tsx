import { ImageBackground, StyleSheet, Text, View, Image, Linking, ScrollView } from 'react-native';
            ...
            <ScrollView contentContainerStyle={styles.scrollViewContent}>
                ...
                <View style={styles.content}>
                    ...
                    >
                        ...
                        <TextTitle text={"CHĂM SÓC CƠ-XƯƠNG-KHỚP"} fontSize={20} />
                        <TextTitle text={"NHẬN LỘC SỨC KHỎE TỪ ANLENE"} fontSize={16} marginTop={-5} />
